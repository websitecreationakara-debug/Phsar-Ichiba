...
function AccountPage() {
  ...
  if (loading) {
    return <div className="mx-auto max-w-md px-4 py-16 text-center text-ink-soft">Loading…</div>
  }
  ...
  return (
    <div className="mx-auto max-w-md px-4 py-16">
      ...
      <p className="mt-1 text-center text-sm text-ink-soft">
        {mode === 'signin' ? 'Sign in to track orders and save your favorites.' : 'Join Phsar Ichiba for faster checkout.'}
      </p>
