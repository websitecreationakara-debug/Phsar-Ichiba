...
const ja = {
  ...
  "checkout.customerNumber": "お客様番号",
  "checkout.customerNumberPlaceholder": "お客様番号を入力してください",
  "checkout.address": "住所",
  ...
  "checkout.dragPinHint": "ピンをドラッグするか地図をタップして正確な位置を指定できます。",
  "checkout.city": "市区町村",
  "checkout.saveAddress": "この住所を保存する",
  "checkout.guestSavedOnDevice": "ご入力内容はこの端末に保存され、次回は自動入力されます。",
  "checkout.guestSignInForMore": "ログインすると住所録に保存できます",
  ...
  "checkout.cod": "QR決済（KHQR）",
  "checkout.codDesc": "商品到着時にQRコード経由でお支払いください",
  "checkout.cashOnPickup": "店頭払い",
  "checkout.cashOnPickupDesc": "店舗でお受け取りの際に現金でお支払いください。",
  ...
  "account.twoFactorTitle": "二段階認証",
  "account.twoFactorSub": "認証アプリに表示されている6桁のコードを入力してください。",
  "account.twoFactorCode": "認証コード",
  "account.twoFactorVerifyBtn": "確認して続行",
  "account.securityTitle": "セキュリティ",
  "account.twoFactorManageDesc": "サインイン時に認証アプリのコードを要求します。",
...
const en: Dict = {
  ...
  "checkout.phonePlaceholder": "+855 12 345 678",
  "checkout.customerNumber": "Customer number",
  "checkout.customerNumberPlaceholder": "Enter your customer number",
  ...
  "checkout.dragPinHint": "Drag the pin or tap the map to set your exact location.",
  "checkout.city": "City",
  "checkout.saveAddress": "Save this address to my address book",
  "checkout.guestSavedOnDevice": "Your details will be remembered on this device for next time.",
  "checkout.guestSignInForMore": "Sign in to save addresses to your account",
  ...
  "checkout.cod": "Pay by KHQR",
  "checkout.codDesc": "Pay by KHQR when you receive your order.",
  "checkout.cashOnPickup": "Cash on Pickup",
  "checkout.cashOnPickupDesc": "Pay with cash when you pick up your order at the store.",
  ...
  "account.twoFactorSub": "Enter the 6-digit code from your authenticator app.",
  "account.twoFactorCode": "Authenticator code",
  "account.twoFactorVerifyBtn": "Verify & continue",
  "account.securityTitle": "Security",
  "account.twoFactorManageDesc": "Require an authenticator code when you sign in.",
