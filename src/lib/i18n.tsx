...
const ja = {
  ...
  "checkout.pinLocationTitle": "配達先の位置を指定",
  "checkout.mapSearchPlaceholder": "住所やエリアを検索",
  "checkout.mapSearch": "検索",
  "checkout.useMyLocation": "現在地を使用",
  "checkout.mapHint": "ピンをタップまたはドラッグして正確な位置を指定してください",
  "checkout.confirmPin": "この位置を確定",
  "checkout.confirming": "確定中…",
  "checkout.noResults": "該当する結果がありません",
  "checkout.searching": "検索中…",
  "checkout.city": "市区町村",
...
const en: Dict = {
  ...
  "checkout.pinLocationTitle": "Pin your delivery location",
  "checkout.mapSearchPlaceholder": "Search for an address or area",
  "checkout.mapSearch": "Search",
  "checkout.useMyLocation": "Use my current location",
  "checkout.mapHint": "Tap or drag the pin to set your exact spot",
  "checkout.confirmPin": "Confirm pin",
  "checkout.confirming": "Confirming…",
  "checkout.noResults": "No matches found",
