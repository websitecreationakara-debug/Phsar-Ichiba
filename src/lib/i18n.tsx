...
const ja = {
  ...
  "checkout.pickAPickupTime": "受け取り時間を選択してください。",
  "checkout.today": "本日",
  ...
  "checkout.date": "日付",
  "checkout.time": "時間",
  "checkout.pickTime": "時間を選択",
  "checkout.noSlotsToday": "本日の配送枠は終了しました。別の日を選択してください。",
  "checkout.pickDateTime": "日時を選択するか、「できるだけ早く」に戻してください。",
...
const en: Dict = {
  ...
  "checkout.pickAPickupTime": "Please choose a pickup time.",
  ...
  "checkout.noSlotsToday": "No more delivery slots today — please choose another date.",
  "checkout.pickDateTime": 'Pick a date and time, or switch back to "As soon as possible."',
